...
findmonster = seamonsterreg.replace('#','O').replace('[O','[#')

#print(findmonster)

def replacehash(matchobj):
  #print('regex matches')
  string = matchobj.string
  #print('matchobj groups', matchobj.groups())
  for g in range(1,len(matchobj.groups())+1):
    #print(matchobj.span(g))
    span = matchobj.span(g)
    #print('string------')
    #print(string)
    #print('-------')
    string=string[:span[0]]+'M'+string[span[1]:]
    #print('string------')
    #print(string)
    #print('-------')
  groupspan = matchobj.span(0)
  return string[slice(*groupspan)]
...
print('----')
"""
regtest = re.sub(findmonster, replacehash, regtest, 0)
"""
print('----')
print(regtest)
print('----')
...
for o in range(16):
    print(o)
    image = flip(image,o)
    print('before',len(re.findall(seamonsterreg, image)))
    image = re.sub(seamonsterreg, replacehash, image,0)
    print('wavecoun',image.count('#'))
    print('after',len(re.findall(seamonsterreg, image)))
